...
Joe180_Cop_BivBinary <- function(marg1 = NULL, marg2 = NULL,
  ...
  gradient_marg_gen <- function(cdf1, cdf2, dercdf1){
    ...
    expr({
      ...
      P11 <- pdffz( F1_Tilde + F2_Tilde - 1 + ( 1 - (bit1 + bit2 - bit1*bit2)^(1/thet) ) )
      
      P00 <- pdffz(1 - F1_Tilde - F2_Tilde + P11)
      
      P10 <- pdffz( F1_Tilde - P11 )
      
      P01 <- pdffz( F2_Tilde - P11)
      ...
      derp11_dercdf1 <- dvffz( ((1 - F1)^thet + (1 - F2)^thet - (1 - F1)^thet * (1 - F2)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - F1)^(thet - 1) * thet - (1 - F1)^(thet - 1) * thet * (1 - F2)^thet)) )
  ...
  gradient_margin2_gen <- function(cdf1, cdf2, dercdf2){
    ...
    expr({
      ...
      derp11_dercdf2 <- dvffz( ((1 - F1)^thet + (1 - F2)^thet - (1 - F1)^thet * (1 - F2)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - F2)^(thet - 1) * thet - (1 - F1)^thet * ((1 - F2)^(thet - 1) * thet)))  )
  ...
  gradient_cop_gen <- function(cdf1, cdf2, rho){
    ...
    expr({
      ...
      derp11_derrho <- dvffz( (((1 - F1)^thet - (-1 + (1 - F1)^thet) *(1 - F2)^thet)^(1/thet)* (log((1 - F1)^thet - (-1 + (1 - F1)^thet)* (1 - F2)^thet) + (
  ...
  name_cop <- "Rotated Joe (180°) Copula for bivariate binary responses: rho(... link)"                                       
