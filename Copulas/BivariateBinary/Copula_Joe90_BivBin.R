...
Joe90_Cop_BivBinary <- function(marg1 = NULL, marg2 = NULL,
  ...
  gradient_marg_gen <- function(cdf1, cdf2, dercdf1){
    ...
    expr({
      ...
      P11 <- pdffz( F2 - ( 1 - (bit1 + bit2 - bit1*bit2)^(1/thet) ) )
  ...
  name_fam <- paste("JoeCop90", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "Rotated Joe (90°) Copula for bivariate binary responses: rho(... link)"                                       
