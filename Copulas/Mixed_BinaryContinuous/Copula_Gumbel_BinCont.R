...
Gumbel_Cop_BinCont <- function(marg1 = NULL, marg2 = NULL,
  ...
  name_fam <- paste("GumbelCop (Mixed binary - continuous margins)", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "Gumbel copula with mixed binary and continuous margins: rho(... link)"                                       
