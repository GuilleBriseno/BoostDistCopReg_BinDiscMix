...
source("Marginals/Continuous/Marginal_Gamma.R")
...
Clayton_Cop_BinCont <- function(marg1 = NULL, marg2 = NULL,
  ...
  name_fam <- paste("ClaytonCop (Mixed binary - continuous margins)", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "Clayton copula with mixed binary and continuous margins: rho(... link)"                                       
