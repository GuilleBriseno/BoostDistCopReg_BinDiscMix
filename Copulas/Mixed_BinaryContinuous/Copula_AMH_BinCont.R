...
AMH_Cop_BinCont <- function(marg1 = NULL, marg2 = NULL,
  ...
  gradient_margin1_gen <- function(cdf1, cdf2, dercdf1){
    ...
    expr({
      ...
      HFunc <- pdffz( F1 * (1 - F2 * thet * (1 - F1)/(1 - thet * (1 - F1) * (1 - F2)))/(1 - thet * (1 - F1) * (1 - F2)) )
      
      ####################
      dHFunc_dF1 <-  (1 - thet * (F1 * (1 - F2 * (2 + 2 * (thet * (1 - F1) * (1 - F2)/(1 - thet * (1 - F1) * (1 - F2))))) + F2 * (1 - F1))/(1 - thet * (1 - F1) * (1 - F2)))/(1 - thet * (1 - F1) * (1 - F2)) 
  ...
  gradient_margin2_gen <- function(cdf1, cdf2, dercdf2, derlpdf2){
    ...
    expr({
      ...
      ################## Partial derivatives
      dHFunc_dF2 <-  -(F1 * thet * (1 - F1) * (2 - 2 * (F2 * thet * (1 - F1)/(1 - thet * (1 - F1) * (1 - F2))))/(1 - thet * (1 - F1) * (1 - F2))^2) 
  ...
  gradient_cop_gen <- function(cdf1, cdf2, rho){
    ...
    expr({
      ...
      ################### Partial derivatives:
      dHfunc_dTheta <-  F2 * (1 - F1 * (2 + 2 * (thet * (1 - F1) * (1 - F2)/(1 - thet * (1 - F1) * (1 - F2))))) * (1 - F2)/(1 - thet * (1 - F1) * (1 - F2))^2 
  ...
  name_fam <- paste("AMHCop (Mixed binary - continuous margins)", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "AMH copula with mixed binary and continuous margins: rho(... link)"                                       
