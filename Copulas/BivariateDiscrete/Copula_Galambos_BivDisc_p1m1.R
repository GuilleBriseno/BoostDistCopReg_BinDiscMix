...
### Copula function (for bivariate binary margins)

Galambos_Cop_BivDiscrete <- function(marg1 = NULL, marg2 = NULL,
  ...
  rho_simp <- expr(rho)
  #rho_gen <- expr(tanh(f))
  rho_gen <- expr({  exp( check_eta_theta(f, coptype = "CLAYTON") ) })
  ...
  gradient_marg_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf1, derpdf1){
    ...
    expr({
      ...
      T1 <- pdffz( F1*F2*exp(((-log(F1))^(-thet)+(-log(F2))^(-thet))^(-1/thet))   )
      
      T2 <- pdffz( CDF1m1*F2*exp(((-log(CDF1m1))^(-thet)+(-log(F2))^(-thet))^(-1/thet))   ) 
      
      T3 <- pdffz( F1*CDF2m1*exp(((-log(F1))^(-thet)+(-log(CDF2m1))^(-thet))^(-1/thet))  ) 
      
      T4 <- pdffz( CDF1m1*CDF2m1*exp(((-log(CDF1m1))^(-thet)+(-log(CDF2m1))^(-thet))^(-1/thet))  ) 
      ...
      dT1_dF1 <- dvffz( F2*(1-1/((-log(F1))^(1+thet)*(1/(-log(F1))^thet+
                                                        1/(-log(F2))^thet)^(1+1/thet)))*exp((1/(-log(F1))^thet+
                                                                                               1/(-log(F2))^thet)^-(1/thet)) )
      
      dT2_dF1 <- dvffz( F2*(1-1/((-log(CDF1m1))^(1+thet)*(1/(-log(CDF1m1))^thet+
                                                        1/(-log(F2))^thet)^(1+1/thet)))*exp((1/(-log(CDF1m1))^thet+
                                                                                               1/(-log(F2))^thet)^-(1/thet)) )
      
      dT3_dF1 <- dvffz( CDF2m1*(1-1/((-log(F1))^(1+thet)*(1/(-log(F1))^thet+
                                                        1/(-log(CDF2m1))^thet)^(1+1/thet)))*exp((1/(-log(F1))^thet+
                                                                                               1/(-log(CDF2m1))^thet)^-(1/thet)) )
      
      dT4_dF1 <- dvffz( CDF2m1*(1-1/((-log(CDF1m1))^(1+thet)*(1/(-log(CDF1m1))^thet+
                                                            1/(-log(CDF2m1))^thet)^(1+1/thet)))*exp((1/(-log(CDF1m1))^thet+
                                                                                                       1/(-log(CDF2m1))^thet)^-(1/thet)) )
  ...
  gradient_margin2_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf2, derpdf2){
    ...
    expr({
      ...
      dT1_dF2 <- dvffz( F1*(1-1/((-log(F2))^(1+thet)*(1/(-log(F1))^thet+
                                                        1/(-log(F2))^thet)^(1+1/thet)))*exp((1/(-log(F1))^thet+
                                                                                               1/(-log(F2))^thet)^-(1/thet)) )
      
      dT2_dF2 <- dvffz( CDF1m1*(1-1/((-log(F2))^(1+thet)*(1/(-log(CDF1m1))^thet+
                                                        1/(-log(F2))^thet)^(1+1/thet)))*exp((1/(-log(CDF1m1))^thet+
                                                                                               1/(-log(F2))^thet)^-(1/thet)) )
      
      dT3_dF2 <- dvffz( F1*(1-1/((-log(CDF2m1))^(1+thet)*(1/(-log(F1))^thet+
                                                        1/(-log(CDF2m1))^thet)^(1+1/thet)))*exp((1/(-log(F1))^thet+
                                                                                               1/(-log(CDF2m1))^thet)^-(1/thet)) )
      
      dT4_dF2 <- dvffz( CDF1m1*(1-1/((-log(CDF2m1))^(1+thet)*(1/(-log(CDF1m1))^thet+
                                                            1/(-log(CDF2m1))^thet)^(1+1/thet)))*exp((1/(-log(CDF1m1))^thet+
                                                                                                       1/(-log(CDF2m1))^thet)^-(1/thet)) )
  ...
  gradient_cop_gen <- function(cdf1, cdf2, pdf1, pdf2, rho){
    ...
    expr({
      ...
      dT1_dtheta <- dvffz( F1*F2*((log(-log(F1))/(-log(F1))^thet+log(-log(F2))/(-log(F2))^thet)/(1/(-log(F1))^thet+
                                                                                                   1/(-log(F2))^thet)^(1+1/thet)+log(1/(-log(F1))^thet+
                                                                                                                                       1/(-log(F2))^thet)/(thet*(1/(-log(F1))^thet+1/(-log(F2))^thet)^(1/thet)))*
                             exp((1/(-log(F1))^thet+1/(-log(F2))^thet)^-(1/thet))/thet )
      
      dT2_dtheta <- dvffz( CDF1m1*F2*((log(-log(CDF1m1))/(-log(CDF1m1))^thet+log(-log(F2))/(-log(F2))^thet)/(1/(-log(CDF1m1))^thet+
                                                                                                   1/(-log(F2))^thet)^(1+1/thet)+log(1/(-log(CDF1m1))^thet+
                                                                                                                                       1/(-log(F2))^thet)/(thet*(1/(-log(CDF1m1))^thet+1/(-log(F2))^thet)^(1/thet)))*
                             exp((1/(-log(CDF1m1))^thet+1/(-log(F2))^thet)^-(1/thet))/thet )
      
      dT3_dtheta <- dvffz( F1*CDF2m1*((log(-log(F1))/(-log(F1))^thet+log(-log(CDF2m1))/(-log(CDF2m1))^thet)/(1/(-log(F1))^thet+
                                                                                                   1/(-log(CDF2m1))^thet)^(1+1/thet)+log(1/(-log(F1))^thet+
                                                                                                                                       1/(-log(CDF2m1))^thet)/(thet*(1/(-log(F1))^thet+1/(-log(CDF2m1))^thet)^(1/thet)))*
                             exp((1/(-log(F1))^thet+1/(-log(CDF2m1))^thet)^-(1/thet))/thet )
      
      dT4_dtheta <- dvffz( CDF1m1*CDF2m1*((log(-log(CDF1m1))/(-log(CDF1m1))^thet+log(-log(CDF2m1))/(-log(CDF2m1))^thet)/(1/(-log(CDF1m1))^thet+
                                                                                                               1/(-log(CDF2m1))^thet)^(1+1/thet)+log(1/(-log(CDF1m1))^thet+
                                                                                                                                                       1/(-log(CDF2m1))^thet)/(thet*(1/(-log(CDF1m1))^thet+1/(-log(CDF2m1))^thet)^(1/thet)))*
                             exp((1/(-log(CDF1m1))^thet+1/(-log(CDF2m1))^thet)^-(1/thet))/thet  )
  ...
  name_fam <- paste("GalambosCop", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "Galambos copula for bivariate discrete / count responses: rho(... link)"                                       
