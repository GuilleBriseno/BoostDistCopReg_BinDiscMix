...
AMH_Cop_BivDiscrete <- function(marg1 = NULL, marg2 = NULL,
  ...
  gradient_marg_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf1, derpdf1){
    ...
    expr({
      ...
      dT1_dF1 <- dvffz( F2 * (1 - F1 * thet * (1 - F2)/(1 - thet * (1 - F1) * (1 - F2)))/(1 - thet * (1 - F1) * (1 - F2)) )
      
      dT2_dF1 <- dvffz( CDF2m1 * (1 - F1 * thet * (1 - CDF2m1)/(1 - thet * (1 - F1) * (1 - CDF2m1)))/(1 - thet * (1 - F1) * (1 - CDF2m1)) )
      
      dT3_dF1 <- dvffz(  F2 * (1 - CDF1m1 * thet * (1 - F2)/(1 - thet * (1 - CDF1m1) * (1 - F2)))/(1 - thet * (1 - CDF1m1) * (1 - F2))  )
      
      dT4_dF1 <- dvffz( CDF2m1 * (1 - CDF1m1 * thet * (1 - CDF2m1)/(1 - thet * (1 - CDF1m1) * (1 - CDF2m1)))/(1 - thet * (1 - CDF1m1) * (1 - CDF2m1))  ) 
  ...
  gradient_margin2_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf2, derpdf2){
    ...
    expr({
      ...
      dT1_dF2 <- dvffz( F1 * (1 - F2 * thet * (1 - F1)/(1 - thet * (1 - F1) * (1 - F2)))/(1 - thet * (1 - F1) * (1 - F2)) )
      
      dT2_dF2 <- dvffz( CDF1m1 * (1 - F2 * thet * (1 - CDF1m1)/(1 - thet * (1 - CDF1m1) * (1 - F2)))/(1 - thet * (1 - CDF1m1) * (1 - F2)) )
      
      dT3_dF2 <- dvffz( F1 * (1 - CDF2m1 * thet * (1 - F1)/(1 - thet * (1 - F1) * (1 - CDF2m1)))/(1 - thet * (1 - F1) * (1 - CDF2m1)) )
      
      dT4_dF2 <- dvffz( CDF1m1 * (1 - CDF2m1 * thet * (1 - CDF1m1)/(1 - thet * (1 - CDF1m1) * (1 - CDF2m1)))/(1 - thet * (1 - CDF1m1) * (1 - CDF2m1)) )
  ...
  gradient_cop_gen <- function(cdf1, cdf2, pdf1, pdf2, rho){
    ...
    expr({
      ...
      dT1_dtheta <- F1 * F2 * (1 - F1) * (1 - F2)/(1 - thet * (1 - F1) * (1 - F2))^2
      
      dT2_dtheta <- CDF1m1 * F2 * (1 - CDF1m1) * (1 - F2)/(1 - thet * (1 - CDF1m1) * (1 - F2))^2
      
      dT3_dtheta <- F1 * CDF2m1 * (1 - F1) * (1 - CDF2m1)/(1 - thet * (1 - F1) * (1 - CDF2m1))^2
      
      dT4_dtheta <- CDF1m1 * CDF2m1 * (1 - CDF1m1) * (1 - CDF2m1)/(1 - thet * (1 - CDF1m1) * (1 - CDF2m1))^2
  ...
  name_fam <- paste("AMHCop", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "AMH copula for bivariate discrete / count responses: rho(... link)"                                       
