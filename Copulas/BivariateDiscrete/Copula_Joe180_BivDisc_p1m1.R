...
Joe180_Cop_BivDiscrete <- function(marg1 = NULL, marg2 = NULL,
  ...
  gradient_marg_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf1, derpdf1){
    ...
    expr({
      ...
      CDF1m1_Tilde <- pdffz(F1_Tilde - (!!pdf1))
      
      CDF2m1_Tilde <- pdffz(F2_Tilde - (!!pdf2))
      ###############################################################################################################################################
      ...
      dT1_dF1 <- dvffz( ((1 - F1)^thet + (1 - F2)^thet - (1 - F1)^thet * (1 - F2)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - F1)^(thet - 1) * thet - (1 - F1)^(thet - 1) * thet * (1 - F2)^thet)) )
      
      dT2_dF1 <- dvffz( ((1 - CDF1m1)^thet + (1 - F2)^thet - (1 - CDF1m1)^thet * (1 - F2)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - CDF1m1)^(thet - 1) * thet - (1 - CDF1m1)^(thet - 1) * thet * (1 - F2)^thet)) )
      
      dT3_dF1 <- dvffz( ((1 - F1)^thet + (1 - CDF2m1)^thet - (1 - F1)^thet * (1 - CDF2m1)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - F1)^(thet - 1) * thet - (1 - F1)^(thet - 1) * thet * (1 - CDF2m1)^thet))  )
      
      dT4_dF1 <- dvffz( ((1 - CDF1m1)^thet + (1 - CDF2m1)^thet - (1 - CDF1m1)^thet * (1 - CDF2m1)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - CDF1m1)^(thet - 1) * thet - (1 - CDF1m1)^(thet - 1) * thet * (1 - CDF2m1)^thet)) )
  ...
  gradient_margin2_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf2, derpdf2){
    ...
    expr({
      ...
      dT1_dF2 <- dvffz(  ((1 - F1)^thet + (1 - F2)^thet - (1 - F1)^thet * (1 - F2)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - F2)^(thet - 1) * thet - (1 - F1)^thet * ((1 - F2)^(thet - 1) * thet))) )
      
      dT2_dF2 <- dvffz(  ((1 - CDF1m1)^thet + (1 - F2)^thet - (1 - CDF1m1)^thet * (1 - F2)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - F2)^(thet - 1) * thet - (1 - CDF1m1)^thet * ((1 - F2)^(thet - 1) * thet))) )
      
      dT3_dF2 <- dvffz( ((1 - F1)^thet + (1 - CDF2m1)^thet - (1 - F1)^thet * (1 - CDF2m1)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - CDF2m1)^(thet - 1) * thet - (1 - F1)^thet * ((1 - CDF2m1)^(thet - 1) * thet))) )
      
      dT4_dF2 <- dvffz(  ((1 - CDF1m1)^thet + (1 - CDF2m1)^thet - (1 - CDF1m1)^thet * (1 - CDF2m1)^thet)^((1/thet) - 1) * ((1/thet) * ((1 - CDF2m1)^(thet - 1) * thet - (1 - CDF1m1)^thet * ((1 - CDF2m1)^(thet - 1) * thet))) )
  ...
  gradient_cop_gen <- function(cdf1, cdf2, pdf1, pdf2, rho){
    ...
    expr({
      ...
      dT1_dtheta <- dvffz( (((1 - F1)^thet - (-1 + (1 - F1)^thet) *(1 - F2)^thet)^(1/thet)* (log((1 - F1)^thet - (-1 + (1 - F1)^thet)* (1 - F2)^thet) + (
        thet* ((1 - F1)^thet* (-1 + (1 - F2)^thet)* log(1 - F1) + (-1 + (1 - F1)^thet) *(1 - F2)^thet* log(1 - F2)))/((1 - F1)^thet - (-1 + (1 - F1)^thet)* (1 - F2)^thet)))/thet^2 )
      
      dT2_dtheta <- dvffz( (((1 - CDF1m1)^thet - (-1 + (1 - CDF1m1)^thet) *(1 - F2)^thet)^(1/thet)* (log((1 - CDF1m1)^thet - (-1 + (1 - CDF1m1)^thet)* (1 - F2)^thet) + (
        thet* ((1 - CDF1m1)^thet* (-1 + (1 - F2)^thet)* log(1 - CDF1m1) + (-1 + (1 - CDF1m1)^thet) *(1 - F2)^thet* log(1 - F2)))/((1 - CDF1m1)^thet - (-1 + (1 - CDF1m1)^thet)* (1 - F2)^thet)))/thet^2 )
      
      dT3_dtheta <- dvffz( (((1 - F1)^thet - (-1 + (1 - F1)^thet) *(1 - CDF2m1)^thet)^(1/thet)* (log((1 - F1)^thet - (-1 + (1 - F1)^thet)* (1 - CDF2m1)^thet) + (
        thet* ((1 - F1)^thet* (-1 + (1 - CDF2m1)^thet)* log(1 - F1) + (-1 + (1 - F1)^thet) *(1 - CDF2m1)^thet* log(1 - CDF2m1)))/((1 - F1)^thet - (-1 + (1 - F1)^thet)* (1 - CDF2m1)^thet)))/thet^2  )
      
      dT4_dtheta <- dvffz(  (((1 - CDF1m1)^thet - (-1 + (1 - CDF1m1)^thet) *(1 - CDF2m1)^thet)^(1/thet)* (log((1 - CDF1m1)^thet - (-1 + (1 - CDF1m1)^thet)* (1 - CDF2m1)^thet) + (
        thet* ((1 - CDF1m1)^thet* (-1 + (1 - CDF2m1)^thet)* log(1 - CDF1m1) + (-1 + (1 - CDF1m1)^thet) *(1 - CDF2m1)^thet* log(1 - CDF2m1)))/((1 - CDF1m1)^thet - (-1 + (1 - CDF1m1)^thet)* (1 - CDF2m1)^thet)))/thet^2  )
  ...
  name_fam <- paste("JoeCop", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "Rotated Joe (180°) copula for bivariate discrete / count responses: rho(... link)"                                       
