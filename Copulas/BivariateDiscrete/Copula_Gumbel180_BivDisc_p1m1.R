...
### Gumbel-Copula function (for bivariate binary margins)
...
Gumbel180_Cop_BivDiscrete <- function(marg1 = NULL, marg2 = NULL,
  ...
  rho_simp <- expr(rho)
  #rho_gen <- expr(tanh(f))
  rho_gen <- expr({  exp( check_eta_theta(f, coptype = "GUMBEL") ) + 1 })
  ...
  gradient_marg_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf1, derpdf1){
    ...
    expr({
      ...
      CDF1m1 <- pdffz(1 - F1 - (!!pdf1))
      
      CDF2m1 <- pdffz(1 - F2 - (!!pdf2))
      
      
      thet <- rho
      
      T1 <- pdffz(pdffz(!!cdf1) + pdffz(!!cdf2) - 1 +  pdffz( exp( - ( (-log(F1))^thet + (-log(F2))^thet )^(1/thet) )  ))
      
      T2 <- pdffz(pdffz(F1 - (!!pdf1)) + pdffz(!!cdf2) - 1 +  pdffz( exp( - ( (-log(CDF1m1))^thet + (-log(F2))^thet )^(1/thet) )  )) 
      
      T3 <- pdffz(pdffz(!!cdf1) + pdffz(F2 - (!!pdf2)) - 1 +  pdffz( exp( - ( (-log(F1))^thet + (-log(CDF2m1))^thet )^(1/thet) )  ))
      
      T4 <- pdffz(pdffz(F1 - (!!pdf1)) + pdffz(F2 - (!!pdf2)) - 1 +  pdffz( exp( - ( (-log(CDF1m1))^thet + (-log(CDF2m1))^thet )^(1/thet) )  ))
      ...
      dT1_dF1 <- dvffz(1 - ( (exp(-((-log(F1))^thet + (-log(F2))^thet)^((1/thet)))* (-log(F1))^(-1 + thet)* ((-log(F1))^thet + (-log(F2))^thet)^(-1 + 1/thet))/F1) )
      
      dT2_dF1 <- dvffz(1 - ((exp(-((-log(CDF1m1))^thet + (-log(F2))^thet)^((1/thet)))* (-log(CDF1m1))^(-1 + thet)* ((-log(CDF1m1))^thet + (-log(F2))^thet)^(-1 + 1/thet))/CDF1m1 ))
      
      dT3_dF1 <- dvffz(1 - ((exp(-((-log(F1))^thet + (-log(CDF2m1))^thet)^((1/thet)))* (-log(F1))^(-1 + thet)* ((-log(F1))^thet + (-log(CDF2m1))^thet)^(-1 + 1/thet))/F1)  )
      
      dT4_dF1 <- dvffz(1 - ((exp(-((-log(CDF1m1))^thet + (-log(CDF2m1))^thet)^((1/thet)))* (-log(CDF1m1))^(-1 + thet)* ((-log(CDF1m1))^thet + (-log(CDF2m1))^thet)^(-1 + 1/thet))/CDF1m1 ))
  ...
  gradient_margin2_gen <- function(cdf1, cdf2, pdf1, pdf2, dercdf2, derpdf2){
    ...
    expr({
      ...
      dT1_dF2 <- dvffz(1 - ( (exp(-((-log(F2))^thet + (-log(F1))^thet)^((1/thet)))* (-log(F2))^(-1 + thet)* ((-log(F2))^thet + (-log(F1))^thet)^(-1 + 1/thet))/F2 ))
      
      dT2_dF2 <- dvffz(1 - ( (exp(-((-log(F2))^thet + (-log(CDF1m1))^thet)^((1/thet)))* (-log(F2))^(-1 + thet)* ((-log(F2))^thet + (-log(CDF1m1))^thet)^(-1 + 1/thet))/F2 ))
      
      dT3_dF2 <- dvffz(1 - ( (exp(-((-log(CDF2m1))^thet + (-log(F1))^thet)^((1/thet)))* (-log(CDF2m1))^(-1 + thet)* ((-log(CDF2m1))^thet + (-log(F1))^thet)^(-1 + 1/thet))/CDF2m1 ))
      
      dT4_dF2 <- dvffz(1 - ( (exp(-((-log(CDF2m1))^thet + (-log(CDF1m1))^thet)^((1/thet)))* (-log(CDF2m1))^(-1 + thet)* ((-log(CDF2m1))^thet + (-log(CDF1m1))^thet)^(-1 + 1/thet))/CDF2m1 ))
  ...
  gradient_cop_gen <- function(cdf1, cdf2, pdf1, pdf2, rho){
    ...
    expr({
      ...
      dT1_dtheta <- dvffz( (1/(thet^2))*exp(-((-log(F1))^thet + (-log(F2))^thet)^((1/thet)))* ((-log(F1))^thet + (-log(F2))^thet)^(-1 + 1/thet)* (-thet* (-log(F1))^thet* log(-log(F1)) + ((-log(F1))^thet + (-log(F2))^thet)* log((-log(F1))^thet + (-log(F2))^thet) - thet *(-log(F2))^thet* log(-log(F2))) )
      
      dT2_dtheta <- dvffz( (1/(thet^2))*exp(-((-log(CDF1m1))^thet + (-log(F2))^thet)^((1/thet)))* ((-log(CDF1m1))^thet + (-log(F2))^thet)^(-1 + 1/thet)* (-thet* (-log(CDF1m1))^thet* log(-log(CDF1m1)) + ((-log(CDF1m1))^thet + (-log(F2))^thet)* log((-log(CDF1m1))^thet + (-log(F2))^thet) - thet *(-log(F2))^thet* log(-log(F2))))
      
      dT3_dtheta <- dvffz(  (1/(thet^2))*exp(-((-log(F1))^thet + (-log(CDF2m1))^thet)^((1/thet)))* ((-log(F1))^thet + (-log(CDF2m1))^thet)^(-1 + 1/thet)* (-thet* (-log(F1))^thet* log(-log(F1)) + ((-log(F1))^thet + (-log(CDF2m1))^thet)* log((-log(F1))^thet + (-log(CDF2m1))^thet) - thet *(-log(CDF2m1))^thet* log(-log(CDF2m1)))   )
      
      dT4_dtheta <- dvffz( (1/(thet^2))*exp(-((-log(CDF1m1))^thet + (-log(CDF2m1))^thet)^((1/thet)))* ((-log(CDF1m1))^thet + (-log(CDF2m1))^thet)^(-1 + 1/thet)* (-thet* (-log(CDF1m1))^thet* log(-log(CDF1m1)) + ((-log(CDF1m1))^thet + (-log(CDF2m1))^thet)* log((-log(CDF1m1))^thet + (-log(CDF2m1))^thet) - thet *(-log(CDF2m1))^thet* log(-log(CDF2m1)))  )
  ...
  name_fam <- paste("Gumbel180Cop", marg1$marg_name, marg2$marg_name)
  ...
  name_cop <- "Rotated Gumbel (180°) copula for bivariate discrete / count responses: rho(... link)"                                       
